        ...
        {!slotEditMode && showAuditButton ? (
          <div className="relative z-10 mt-auto shrink-0 pt-2">
            <button
              ...
              className="inline-flex w-full items-center justify-center gap-1 rounded-lg bg-purple-600 px-2 py-1.5 text-[11px] font-bold text-white shadow-sm hover:bg-purple-500"
            >
